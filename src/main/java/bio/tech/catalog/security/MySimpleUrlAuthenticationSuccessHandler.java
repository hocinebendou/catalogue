...
import bio.tech.catalog.spring.LoggedUser;
...
public class MySimpleUrlAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    protected void handle(final HttpServletRequest request, HttpServletResponse response,
                          final Authentication authentication) throws IOException {
    ...
    protected String determineTargetUrl(final Authentication authentication) {
        ...
        boolean isDbac = false;
        boolean isBioArch = false;
        ...
        for (final GrantedAuthority grantedAuthority : authorities) {
            switch (grantedAuthority.getAuthority()) {
                case "READ_PRIVILEGE":
                    isUser = true;
                    break;
                case "UDBAC_PRIVILEGE":
                    isDbac = true;
                    isUser = false;
                    break;
                case "UPLOAD_PRIVILEGE":
                    isBioArch = true;
                    isUser = false;
                    break;
