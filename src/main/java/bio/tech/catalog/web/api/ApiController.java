...
public class ApiController {
	...
	public ResponseEntity<JSONObject> filterStudies(@RequestBody Map<String, Object> body) {
		...
		// 5
		if (groupByColumns.contains("Design") && groupByColumns.contains("Disease") && groupByColumns.contains("Sex") && groupByColumns.contains("Ethnicity")
				&& groupByColumns.contains("SpecType"))
			groupedSpecimens = groupByDesignAndDiseaseAndSexAndEthnicityAndType(specimens, acronymList, designList, diseaseList, sexList, allEthnicities, allSpecimenTypes);
			...
			groupedSpecimens = groupByDesignAndDiseaseAndSexAndTypeAndCountry(specimens, acronymList, designList, diseaseList, sexList, allSpecimenTypes, allCountries);

		else if (groupByColumns.contains("Design") && groupByColumns.contains("Disease") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType")
				&& groupByColumns.contains("Country"))
			groupedSpecimens = groupByDesignAndDiseaseAndEthnicityAndTypeAndCountry(specimens, acronymList, designList, diseaseList, allEthnicities, allSpecimenTypes, allCountries);
				...
				&& groupByColumns.contains("Country"))
			groupedSpecimens = groupByDesignAndDiseaseAndSexAndEthnicityAndCountry(specimens, acronymList, designList, diseaseList, sexList, allEthnicities, allCountries);

		// 4
		else if ( groupByColumns.contains("Disease") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDiseaseAndEthnicityAndTypeAndCountry(specimens, acronymList, diseaseList, allEthnicities, allSpecimenTypes, allCountries);

		else if ( groupByColumns.contains("Disease") && groupByColumns.contains("Sex") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType"))
			groupedSpecimens = groupByDiseaseAndSexAndEthnicityAndType(specimens, acronymList, diseaseList, sexList,allEthnicities, allSpecimenTypes);

		else if ( groupByColumns.contains("Disease") && groupByColumns.contains("Sex") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDiseaseAndSexAndEthnicityAndCountry(specimens, acronymList, diseaseList, sexList,allEthnicities, allCountries);

		else if ( groupByColumns.contains("Disease") && groupByColumns.contains("Sex") && groupByColumns.contains("SpecType") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDiseaseAndSexAndTypeAndCountry(specimens, acronymList, diseaseList, sexList, allSpecimenTypes, allCountries);

		else if ( groupByColumns.contains("Sex") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType") && groupByColumns.contains("Country"))
			groupedSpecimens = groupBySexAndEthnicityAndTypeAndCountry(specimens, acronymList, sexList, allEthnicities, allSpecimenTypes, allCountries);
		...
		else if (groupByColumns.contains("Design") && groupByColumns.contains("Disease") && groupByColumns.contains("SpecType") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDesignAndDiseaseTypeAndCountry(specimens, acronymList, designList, diseaseList, allSpecimenTypes, allCountries);

		else if (groupByColumns.contains("Design") && groupByColumns.contains("Disease") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType"))
			groupedSpecimens = groupByDesignAndDiseaseAndEthnicityAndType(specimens, acronymList, designList, diseaseList, allEthnicities, allSpecimenTypes);
		...
		else if (groupByColumns.contains("Sex") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("SpecType"))
			groupedSpecimens = groupBySexAndEthnicityAndType(specimens, acronymList, sexList, allEthnicities, allSpecimenTypes);
		...
		else if (groupByColumns.contains("Design") && groupByColumns.contains("Ethnicity") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDesignEthnicityAndCountry(specimens, acronymList, designList, allEthnicities, allCountries);
		...
		else if (groupByColumns.contains("Design") && groupByColumns.contains("SpecType") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDesignAndTypeAndCountry(specimens, acronymList, designList, allSpecimenTypes, allCountries);
		...
		else if ( groupByColumns.contains("Disease") && groupByColumns.contains("Sex") && groupByColumns.contains("Country"))
			groupedSpecimens = groupByDiseaseAndSexAndCountry(specimens, acronymList, diseaseList, sexList, allCountries);
		...
		// 2
		...
		else if (groupByColumns.contains("Sex") && groupByColumns.contains("SpecType"))
			groupedSpecimens = groupBySexAndType(specimens, acronymList, sexList, allSpecimenTypes);

		else if (groupByColumns.contains("Sex") && groupByColumns.contains("Country"))
			groupedSpecimens = groupBySexAndCountry(specimens, acronymList, sexList, allCountries);
			...
			groupedSpecimens = groupByDesignAndEthnicity(specimens, acronymList, designList, allEthnicities);
	...
	private List<RowForm> groupByDiseaseAndEthnicityAndTypeAndCountry(List<NeoSpecimen> specimens,
	...
	private List<RowForm> groupBySexAndEthnicityAndType(List<NeoSpecimen> specimens,
												 	  	List<String> acronyms,
												 	  	List<String> sexList,
												 	  	List<String> ethnicities,
												 	  	List<String> specimenTypes) {
	...
	private List<RowForm> groupByDesignAndDiseaseTypeAndCountry(List<NeoSpecimen> specimens,
													  			List<String> acronyms,
													  			List<String> designs,
													  			List<String> diseases,
													  			List<String> specimenTypes,
	...
	private List<RowForm> groupBySexAndCountry(List<NeoSpecimen> specimens,
											   List<String> acronyms,
											   List<String> sexList,
											   List<String> countries) {
		List<RowForm> groupedSpecimens = new ArrayList<>();
	...
	private List<RowForm> groupBySexAndType(List<NeoSpecimen> specimens,
											List<String> acronyms,
											List<String> sexList,
											List<String> specimenTypes) {
	...
	private List<RowForm> groupByDesignAndTypeAndCountry(List<NeoSpecimen> specimens,
														 List<String> acronyms,
														 List<String> designs,
														 List<String> specimenTypes,
														 List<String> countries) {
	...
	private List<RowForm> groupByDiseaseAndSexAndEthnicityAndType(List<NeoSpecimen> specimens,
														   		  List<String> acronyms,
														   		  List<String> diseases,
														   		  List<String> sexList,
														   		  List<String> ethnicities,
	...
	private List<RowForm> groupByDiseaseAndSexAndEthnicityAndCountry(List<NeoSpecimen> specimens,
														   		  	 List<String> acronyms,
														   		  	 List<String> diseases,
														   		  	 List<String> sexList,
														   		  	 List<String> ethnicities,
	...
	private List<RowForm> groupByDiseaseAndSexAndCountry(List<NeoSpecimen> specimens,
														 List<String> acronyms,
														 List<String> diseases,
														 List<String> sexList,
														 List<String> countries) {
	...
	private List<RowForm> groupByDiseaseAndSexAndTypeAndCountry(List<NeoSpecimen> specimens,
																List<String> acronyms,
																List<String> diseases,
																List<String> sexList,
																List<String> specimenTypes,
	...
	private List<RowForm> groupBySexAndEthnicityAndTypeAndCountry(List<NeoSpecimen> specimens,
																  List<String> acronyms,
																  List<String> sexList,
																  List<String> ethnicities,
																  List<String> specimenTypes,
	...
	private List<RowForm> groupByDesignAndDiseaseAndSexAndEthnicityAndType(List<NeoSpecimen> specimens,
																		   List<String> acronyms,
																		   List<String> designs,
																		   List<String> diseases,
																		   List<String> sexList,
	...
	private List<RowForm> groupByDesignAndDiseaseAndEthnicityAndType(List<NeoSpecimen> specimens,
																	 List<String> acronyms,
																	 List<String> designs,
																	 List<String> diseases,
																	 List<String> ethnicities,
	...
	private List<RowForm> groupByDesignAndDiseaseAndSexAndTypeAndCountry(List<NeoSpecimen> specimens,
																		 List<String> acronyms,
																		 List<String> designs,
																		 List<String> diseases,
																		 List<String> sexList,
	...
	private List<RowForm> groupByDesignAndDiseaseAndEthnicityAndTypeAndCountry(List<NeoSpecimen> specimens,
																			   List<String> acronyms,
																			   List<String> designs,
																			   List<String> diseases,
																			   List<String> ethnicities,
	...
	private List<RowForm> groupByDesignAndDiseaseAndSexAndEthnicityAndCountry(List<NeoSpecimen> specimens,
																			  List<String> acronyms,
																			  List<String> designs,
																			  List<String> diseases,
																			  List<String> sexList,
	...
	private List<RowForm> groupByDesignAndSexAndTypeAndCountry(List<NeoSpecimen> specimens,
										   					   List<String> acronyms,
															   List<String> designs,
															   List<String> sexList,
															   List<String> specimenTypes,
	...
	private List<RowForm> groupByDesignAndSexAndEthnicityAndCountry(List<NeoSpecimen> specimens,
										   					   		List<String> acronyms,
															   		List<String> designs,
															   		List<String> sexList,
															   		List<String> ethnicities,
	...
	private List<RowForm> groupByDesignAndEthnicity(List<NeoSpecimen> specimens,
													List<String> acronyms,
													List<String> designs,
													List<String> ethnicities) {
		List<RowForm> groupedSpecimens = new ArrayList<>();
